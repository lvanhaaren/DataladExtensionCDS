# -*- coding: utf-8 -*-
#
# datalad_cds documentation build configuration file, created by
...
project = u'Datalad Cds Extension'
copyright = u'2018-{}, DataLad team'.format(datetime.datetime.now().year)
author = u'I. van Haaren, D. Klauß, B. Bulich'

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
version = datalad_cds_extension.__version__
release = version
